...
import { isValidSyrDid } from '@syren/idp-crypto';
import type { ReactionParentType } from '@syren/types';
 ...
 *     over the viewer's follow graph — but syren is a community app where a
 ...
 * 400 before touching the DB — syren matches so a foreign syr consumer sees the
