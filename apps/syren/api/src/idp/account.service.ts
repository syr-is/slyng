...
/**
 * Local sessions live as long as the syren_session cookie (30 days) —
...
/**
 * Local account registration + login — syren acting as a syr instance.
...
export class AccountService {
	...
	async getRegistrationMode(): Promise<RegistrationMode> {
		...
		const envVal = this.config.get<string>('SYREN_REGISTRATION_MODE');
