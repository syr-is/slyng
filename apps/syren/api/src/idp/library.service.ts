 ...
 *
 * Adapted from syr's upload/folder/file-store-usage controllers to syren's
 * conventions:
 ...
 *  - syren proxies every remote asset through its auth-gated media proxy, so
 ...
 *    limit comes from `SYREN_STORAGE_LIMIT_GB` (default 5).
 *
